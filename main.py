...
class Tab1:
	def optCallback(self):
		...
		_, _, _, _, _, _, KE, V = calculate_obj(a, C, t_wheel, t_rocket, d_wheel, d_rocket, h_rocket, r_rocket, alpha, beta, r_1, r_2, h)
...
class Tab2:
	...
	def calculate(self, val):
		...
		obj, _, _, _, _, _, KE, V = calculate_obj(a, C, t_wheel, t_rocket, d_wheel, d_rocket, h_rocket, r_rocket, alpha, beta, r_1, r_2, h)
